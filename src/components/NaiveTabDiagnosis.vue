...
onMounted(() => {
  formGroups.value = generateFormGroups('n-diag', GROUPS, ['input', 'select', 'textarea', 'datePicker', 'dateTimePicker', 'yearPicker', 'monthPicker', 'timePicker'], FIELDS_PER_GROUP)
...
<template>
  <div ref="rootRef" class="tab-container">
    <div class="form-section" v-for="(rules, idx) in formGroups" :key="'n-diag-' + idx">
...
.section-header { font-size: 14px; font-weight: 600; color: #303133; margin-bottom: 12px; padding-bottom: 8px; border-bottom: 2px solid #18a058; }
