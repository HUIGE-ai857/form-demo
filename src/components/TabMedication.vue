...
onMounted(() => {
  formGroups.value = generateFormGroups('med', GROUPS, ['input', 'select', 'textarea', 'datePicker', 'dateTimePicker', 'yearPicker', 'monthPicker', 'timePicker'], FIELDS_PER_GROUP)
...
.section-header { font-size: 14px; font-weight: 600; color: #303133; margin-bottom: 12px; padding-bottom: 8px; border-bottom: 2px solid #E6A23C; }
